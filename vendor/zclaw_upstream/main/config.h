...
#define SYSTEM_PROMPT \
    ...
    "You can create and run custom tools, control GPIO pins, read a DHT11 temperature and humidity sensor, store persistent memories, and set schedules. " \
...
#define SETUP_MODE_BUTTON_PIN   0
#define SETUP_MODE_HOLD_MS      3000
